<template>
  <a-table bordered :scroll="{ x: 1500 }" :columns="columns" :dataSource="data" class="components-table-demo-nested">
    <a slot="operation" slot-scope="text" href="javascript:;">{{text || 'Publish'}}</a>
    <a-table
    ...
    >
      ...
      <span slot="operation" slot-scope="text" class="table-operation">
        <a href="javascript:;">{{text || 'Pause'}}</a>
